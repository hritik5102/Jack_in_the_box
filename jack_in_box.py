...
cv2.createTrackbar('lh','tb',74,180,nothing)
cv2.createTrackbar('uh','tb',94,180,nothing)
cv2.createTrackbar('ls','tb',15,255,nothing)
cv2.createTrackbar('us','tb',55,255,nothing)
cv2.createTrackbar('lv','tb',52,255,nothing)
cv2.createTrackbar('uv','tb',152,255,nothing)
